...
<!--        <el-table-column prop="businessId" label=" 商家Id" align="center" />-->
        <el-table-column prop="businessName" label="商家名" align="center" />
        <el-table-column prop="businessDesc" label="商家简介" align="center" />
<!--        <el-table-column prop="employee.username" label="用户名" align="center" />-->
<!--        <el-table-column prop="employee.phone" label="联系电话" align="center" />-->
...
import {getData, del, updateStatus, getDataByBusiness, delBusiness} from "@/api/system/user";
import { LayerInterface } from "@/components/layer/index.vue";
import { ElMessage } from "element-plus";
import Table from "@/components/table/index.vue";
import Layer from "./layerBusiness.vue";
