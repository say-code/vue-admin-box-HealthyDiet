...
<!--        <el-table-column prop="id" label="Id" align="center" width="80" />-->
        <el-table-column prop="businessId" label="公司Id" align="center" />
        <el-table-column prop="businessName" label="公司名" align="center" />
...
import {getData, del, updateStatus, getDataByBusiness, getDataByUser} from "@/api/system/user";
